    ...
    while ( have_rows('flex_content') ) : the_row();
        ...
        if( get_row_layout() == 'hero' ):
            ...
            echo '<div class="hero__background-image" style="background-image: url(\'' . $hero_image['url'] . '\');"><div class="container hero">
                <div class="row">
                    <div class="col-sm-6 hero__text-container">
        ...
        elseif( get_row_layout() == '100_2col_rc' ):
            ...
            echo '<div class=" content-section__background-image" style="background-image: url(\'' . $background_image['url'] . '\');"><div class="container content-section">
                    <div class="row">
                        <div class="col-sm-6"></div>
                        <div class="col-sm-6 fade-left-background">
        ...
        elseif( get_row_layout() == '100_2col_lc' ):
            ...
            echo '<div class="content-section__background-image" style="background-image: url(\'' . $background_image['url'] . '\');"><div class="container content-section">
                    <div class="row">
                        <div class="col-sm-6 fade-right-background">
                            <h2 class="blue antiqua">' . $heading . '</h2>' .
                            $copy . '
                        </div>
                        <div class="col-sm-6"></div>
                ...
                if ( have_rows('table')) :
                    ...
                    echo '<div class="row"><div class="col-sm-12 no-padding"><h2 class="blue proxima">' . $heading . '</h2></div>';
                        ...
                        if ( have_rows ('cells')) :
                            ...
                            // layout table below
                                echo '<div class="row"><div class="col-sm-7 cell cell--reverse cell--left">' . $left_cell . '</div><div class="col-sm-5 cell cell--right">' . $right_cell . '</div></div>';
